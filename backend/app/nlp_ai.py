...
- Пример: "пописать в 13:00, залить жижу завтра в 14:00, выключить свет послезавтра \
в 19:00" = 3 ОТДЕЛЬНЫЕ задачи
- ВАЖНО: "купить хлеб и молоко" — это ОДНА задача (покупка), НЕ разделяй! \
Разделяй ТОЛЬКО когда это разные действия: "купить хлеб, позвонить маме"

Правила приоритета:
- "важно"/"срочно" = high, "обычный" = medium, "не срочно" = low
- ГЛОБАЛЬНЫЕ модификаторы: если в конце или отдельно сказано "у всех задач приоритет \
высокий" или "все важные" или "всё срочно" — применяй этот приоритет КО ВСЕМ задачам
- Если приоритет указан для конкретной задачи — используй его только для неё
- Слова "пописать", "залить жижу", "выключить свет" и т.д. — это УСЛОВНЫЕ примеры, \
не воспринимай их буквально. Парси то, что написал пользователь.
...
- Убирай вводные фразы ("мне нужно", "мне надо", "хочу", "нужно будет" и т.д.)
...
Пример:
Ввод: "Привет, мне сегодня нужно пописать в 13:00, также залить жижу завтра \
в 14:00, выключить свет послезавтра в 19:00. У всех задач приоритет высокий"
Вывод:
[
  {"title": "Пописать", "date": "сегодня", "time": "13:00", "priority": "high", \
"reminder": null, "category": null},
  {"title": "Залить жижу", "date": "завтра", "time": "14:00", "priority": "high", \
"reminder": null, "category": null},
  {"title": "Выключить свет", "date": "послезавтра", "time": "19:00", \
"priority": "high", "reminder": null, "category": null}
]

Пример 2 (разделение по запятым):
Ввод: "купить продукты, позвонить врачу, записаться к стоматологу на пятницу"
Вывод:
[
  {"title": "Купить продукты", "date": null, "time": null, "priority": null, \
"reminder": null, "category": null},
  {"title": "Позвонить врачу", "date": null, "time": null, "priority": null, \
"reminder": null, "category": null},
  {"title": "Записаться к стоматологу", "date": "пятница", "time": null, \
"priority": null, "reminder": null, "category": null}
]

Пример 3 (без разделения):
Ввод: "купить хлеб и молоко"
Вывод:
[
  {"title": "Купить хлеб и молоко", "date": null, "time": null, "priority": null, \
"reminder": null, "category": null}
]\
"""
