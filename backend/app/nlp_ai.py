...
- ЗАПЯТАЯ МЕЖДУ ДЕЙСТВИЯМИ = разные задачи: "позвонить маме, купить хлеб" → 2 задачи
- "и" между ОДНОРОДНЫМИ предметами = одна задача: "купить хлеб и молоко" → 1 задача
- "и" между РАЗНЫМИ действиями = разные задачи: "позвонить маме и купить хлеб" → 2 задачи
...
Ввод: "Мне нужно позвонить другу сегодня в 13:00, также купить продукты завтра \
в 14:00, сходить в спортзал послезавтра в 19:00. У всех задач приоритет высокий"
Вывод:
[
  {"title": "Позвонить другу", "date": "сегодня", "time": "13:00", "priority": "high", \
"reminder": null, "category": null},
  {"title": "Купить продукты", "date": "завтра", "time": "14:00", "priority": "high", \
"reminder": null, "category": null},
  {"title": "Сходить в спортзал", "date": "послезавтра", "time": "19:00", \
...
Ввод: "Привет. Мне нужно поставить 2 задачи: попить воду сегодня, включить мышку завтра. У всех приоритет высокий"
Вывод:
[
  {"title": "Попить воду", "date": "сегодня", "time": null, "priority": "high", \
"reminder": null, "category": null},
  {"title": "Включить мышку", "date": "завтра", "time": null, "priority": "high", \
"reminder": null, "category": null}
]\
"""
