...
const ru: Record<string, string> = {
  ...
  "profile.report": "Отчёт",
  "profile.report_sub": "Статистика за неделю и месяц",
  ...
  "onboarding.pet_title": "Питомец",
  "onboarding.pet_text": "Выполняй задачи — получай монеты и опыт. Выращивай питомца, открывай достижения и покупай аксессуары!",
...
const en: Record<string, string> = {
  ...
  "profile.report_sub": "Weekly and monthly statistics",
  ...
  "onboarding.pet_title": "Pet",
  "onboarding.pet_text": "Complete tasks to earn coins and XP. Raise your pet, unlock achievements and buy accessories!",
